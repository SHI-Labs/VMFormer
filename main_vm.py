...
def get_args_parser():
    parser = argparse.ArgumentParser('VMFormer', add_help=False)
    ...
    parser.add_argument('--vm_path', default='../Matting/', type=str)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('VMFormer training script', parents=[get_args_parser()])
